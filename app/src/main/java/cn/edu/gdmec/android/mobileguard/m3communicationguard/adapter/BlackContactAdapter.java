...
public class BlackContactAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if(view == null){
            ...
            holder.mStateTV = (TextView) view.findViewById(R.id.tv_black_state);
        ...
        holder.mNameTV.setText(contactInfos.get(i).contactName+"("+contactInfos.get(i).phoneNumber+")");//////必须
       /////////
      //  holder.mSaoRAOTV.setTextColor(context.getResources().getColor(R.color.bright_purple));
        ...
        holder.mStateTV.setText(contactInfos.get(i).state);//这一步特殊
        holder.mStateTV.setTextColor(context.getResources().getColor(
