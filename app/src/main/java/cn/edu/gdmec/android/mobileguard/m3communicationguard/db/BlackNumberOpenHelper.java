...
public class BlackNumberOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL("create table blacknumber "+"(id integer primary key autoincrement,"+"number varchar(20),"+"name varchar(255),"+"state varchar(255),"+"mode integer)");
    }
